...
void PQ_insert(Item edge);                // Insere Item na PQ. A maior prioridade é a do Item com menor campo 'value'
Item PQ_delmin();                         // Remove Item com menor campo 'value' da PQ
void PQ_decrease_key(int id, Edge value); // Muda a prioridade do nó com identificador 'id' para 'value'
